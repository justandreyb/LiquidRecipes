...
const CREATE_NEWS_SINGLE_REQUEST = "CREATE_NEWS_SINGLE_REQUEST";
const CREATE_NEWS_SINGLE_SUCCESS = "CREATE_NEWS_SINGLE_SUCCESS";
const CREATE_NEWS_SINGLE_FAIL = "CREATE_NEWS_SINGLE_FAIL";

const GET_NEWS_SINGLE_REQUEST = "GET_NEWS_SINGLE_REQUEST";
const GET_NEWS_SINGLE_SUCCESS = "GET_NEWS_SINGLE_SUCCESS";
const GET_NEWS_SINGLE_FAIL = "GET_NEWS_SINGLE_FAIL";

const UPDATE_NEWS_SINGLE_REQUEST = "UPDATE_NEWS_SINGLE_REQUEST";
const UPDATE_NEWS_SINGLE_SUCCESS = "UPDATE_NEWS_SINGLE_SUCCESS";
const UPDATE_NEWS_SINGLE_FAIL = "UPDATE_NEWS_SINGLE_FAIL";

const DELETE_NEWS_SINGLE_REQUEST = "DELETE_NEWS_SINGLE_REQUEST";
const DELETE_NEWS_SINGLE_SUCCESS = "DELETE_NEWS_SINGLE_SUCCESS";
const DELETE_NEWS_SINGLE_FAIL = "DELETE_NEWS_SINGLE_FAIL";

export const CLEAN_NEWS_SINGLE_WORKSPACE = "CLEAN_NEWS_SINGLE_WORKSPACE";
...
export const cleanNewsSingleWorkspace = () => ({
  type: CLEAN_NEWS_SINGLE_WORKSPACE
});
