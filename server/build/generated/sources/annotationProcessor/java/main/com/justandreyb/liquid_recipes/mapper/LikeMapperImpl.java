...
public class LikeMapperImpl implements LikeMapper {
    ...
    public LikeDto toLikeDto(Like like) {
        ...
        if ( like.getUser() != null ) {
            likeDto.setUser( userMapper.toUserDtoAsCreator( like.getUser() ) );
        }
    ...
    @Override
    public LikeDto toLikeDtoWithOnlyId(Like like) {
        if ( like == null ) {
            return null;
        }
    ...
    @Override
    public List<LikeDto> toLikesDtos(Iterable<Like> likes) {
        if ( likes == null ) {
            return null;
        }
    ...
    @Override
    public List<LikeDto> toLikesDtosWithOnlyId(Iterable<Like> likes) {
        if ( likes == null ) {
            return null;
        }
        ...
        List<LikeDto> list = new ArrayList<LikeDto>();
        for ( Like like : likes ) {
            list.add( toLikeDtoWithOnlyId( like ) );
        }
