...
public class FlavorMapperImpl implements FlavorMapper {
    ...
    @Override
    public FlavorDto toFlavorDto(Flavor flavor) {
        if ( flavor == null ) {
            return null;
        }
        ...
        if ( flavor.getManufacturer() != null ) {
            flavorDto.setManufacturer( manufacturerMapper.toManufacturerDtoOnlyWithLogo( flavor.getManufacturer() ) );
        }
        if ( flavor.getFlavorType() != null ) {
            flavorDto.setFlavorType( flavor.getFlavorType() );
        }
        List<CommentDto> list = commentMapper.toCommentDtos( flavor.getComments() );
        if ( list != null ) {
            flavorDto.setComments( list );
        }
        List<LikeDto> list1 = likeMapper.toLikesDtos( flavor.getLikes() );
        if ( list1 != null ) {
            flavorDto.setLikes( list1 );
        }
        if ( flavor.getImage() != null ) {
            flavorDto.setImage( imageMapper.toImageDto( flavor.getImage() ) );
        }
    ...
    @Override
    public FlavorDto toFlavorDtoAsListItem(Flavor flavor) {
        if ( flavor == null ) {
            return null;
        }
        ...
        List<CommentDto> list = commentMapper.toCommentsDtosWithOnlyId( flavor.getComments() );
        if ( list != null ) {
            flavorDto.setComments( list );
        }
        List<LikeDto> list1 = likeMapper.toLikesDtosWithOnlyId( flavor.getLikes() );
        if ( list1 != null ) {
            flavorDto.setLikes( list1 );
        }
        if ( flavor.getImage() != null ) {
    ...
    @Override
    public Flavor fromFlavorDto(FlavorDto flavorDto) {
        if ( flavorDto == null ) {
            return null;
        }
    ...
    @Override
    public List<FlavorDto> toFlavorsDtos(Iterable<Flavor> flavors) {
        if ( flavors == null ) {
            return null;
        }

        List<FlavorDto> list = new ArrayList<FlavorDto>();
        for ( Flavor flavor : flavors ) {
            list.add( toFlavorDtoAsListItem( flavor ) );
        }
