...
public class NewsMapperImpl implements NewsMapper {
    ...
    public NewsDto toNewsDto(News news) {
        ...
        if ( news.getImage() != null ) {
            newsDto.setImage( imageMapper.toImageDto( news.getImage() ) );
        }
        List<CommentDto> list = commentMapper.toCommentDtos( news.getComments() );
        if ( list != null ) {
            newsDto.setComments( list );
        }
        List<LikeDto> list1 = likeMapper.toLikesDtos( news.getLikes() );
        if ( list1 != null ) {
            newsDto.setLikes( list1 );
        }
        if ( news.getCreator() != null ) {
            newsDto.setCreator( userMapper.toUserDtoAsCreator( news.getCreator() ) );
        }
    ...
    @Override
    public NewsDto toNewsDtoAsListItem(News news) {
        if ( news == null ) {
            return null;
        }
        ...
        List<CommentDto> list = commentMapper.toCommentsDtosWithOnlyId( news.getComments() );
        if ( list != null ) {
            newsDto.setComments( list );
        }
        List<LikeDto> list1 = likeMapper.toLikesDtosWithOnlyId( news.getLikes() );
        if ( list1 != null ) {
            newsDto.setLikes( list1 );
        }
        if ( news.getCreator() != null ) {
    ...
    public News fromNewsDto(NewsDto newsDto) {
        ...
        if ( newsDto.getImage() != null ) {
            news.setImage( imageDtoToImage( newsDto.getImage() ) );
        }
        Set<Comment> set = commentDtoListToCommentSet( newsDto.getComments() );
        if ( set != null ) {
            news.setComments( set );
        }
        Set<Like> set1 = likeDtoListToLikeSet( newsDto.getLikes() );
        if ( set1 != null ) {
            news.setLikes( set1 );
        }
        if ( newsDto.getCreator() != null ) {
            news.setCreator( userDtoToUser( newsDto.getCreator() ) );
        }
    ...
    @Override
    public List<NewsDto> toNewsDtos(Iterable<News> news) {
        if ( news == null ) {
            return null;
        }
        ...
        for ( News news1 : news ) {
            list.add( toNewsDtoAsListItem( news1 ) );
        }
