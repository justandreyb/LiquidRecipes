...
public class RecipeItemMapperImpl implements RecipeItemMapper {
    ...
    @Override
    public RecipeItemDto toRecipeItemDto(RecipeItem recipeItem) {
        if ( recipeItem == null ) {
            return null;
        }
        ...
        if ( recipeItem.getFlavor() != null ) {
            recipeItemDto.setFlavor( flavorMapper.toFlavorDtoAsListItem( recipeItem.getFlavor() ) );
        }
    ...
    @Override
    public RecipeItemDto toRecipeItemDtoWithOnlyFlavor(RecipeItem recipeItem) {
        if ( recipeItem == null ) {
            return null;
        }
    ...
    @Override
    public RecipeItem fromRecipeItemDto(RecipeItemDto recipeItemDto) {
    ...
    @Override
    public List<RecipeItemDto> toRecipeItemsDtos(Iterable<RecipeItem> recipeItems) {
        if ( recipeItems == null ) {
            return null;
        }

        List<RecipeItemDto> list = new ArrayList<RecipeItemDto>();
        for ( RecipeItem recipeItem : recipeItems ) {
            list.add( toRecipeItemDto( recipeItem ) );
        }
