...
public class RecipeController {
    ...
    void addItemToRecipe(@RequestParam String id, @RequestBody RecipeItemDto recipeItem) {
    ...
    void addCommentToRecipe(@RequestParam String id, @RequestBody CommentDto comment) {
    ...
    void addLikeToRecipe(@RequestParam String id, @RequestBody LikeDto like) {
        likeService.addToRecipe(id, likeMapper.fromLikeDto(like));
    }

    @PostMapping("/{id}/image")
    void addLikeToRecipe(@RequestParam String id, @RequestBody ImageDto image) {
        imageService.addToRecipe(id, imageMapper.fromImageDto(image));
    }

    @DeleteMapping("/{id}")
    void deleteRecipe(@RequestParam String id) {
        recipeService.delete(id);
    }

    @DeleteMapping("/{id}/items/{itemId}")
    void deleteItemFromRecipe(@RequestParam String itemId) {
        recipeItemService.delete(itemId);
    }

    @DeleteMapping("/{id}/comments/{commentId}")
    void deleteCommentFromRecipe(@RequestParam String commentId) {
        commentService.delete(commentId);
    }

    @DeleteMapping("/{id}/likes/{likeId}")
    void deleteLikeFromRecipe(@RequestParam String likeId) {
